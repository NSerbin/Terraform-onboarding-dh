...
resource "aws_s3_bucket" "onboarding-terra-v2" {
  ...
  resource "aws_s3_bucket_policy" "onboarding-terra2" {
    bucket   = aws_s3_bucket.onboarding-terra-v2.id
    ...
    Statement = [
      {
        ...
        Action = "s3:*"
        Effect = "Allow"
        Resource = [aws_s3_bucket.onboarding-terra-v2.arn,
          "${aws_s3_bucket.onboarding-terra-v2.arn}/*",
        ]
        Principal = "*"
      }
    ]
  ...
  resource "aws_instance" "onboarding-terra2" {
    count = 2
